...
export const repoLink = "https://github.com/RomualdAKM";

export const callToAction = "https://www.linkedin.com/in/dev-romuald-07858624a/";
...
export const experiences = [
  {
    organisation: "VIBECRO CORPORATION",
    // logo: oracle,
...
export const projects = [
  {
    ...
    link: "http://e-learning.fga-numerik.fr/",
    image: 'https://romuald.binarybloom.tech/assets/img/folio6.png',
    content:
      "une application web de formation en ligne",
    stack: [
      {
        id: "icon-1",
        icon: SiReact,
  ...
  },
  {
    ...
    image: 'https://romuald.binarybloom.tech/assets/img/folio7.png',
    content:
      "Site de rencontre pour hommes",
    stack: [
      {
        id: "icon-1",
        icon: SiReact,
  ...
  },
  {
    ...
    image: "https://romuald.binarybloom.tech/assets/img/folio12.png",
    content:
      "Place de marché pour la vente et l'achat de produits numériques",
    stack: [
      {
        id: "icon-1",
        icon: SiReact,
  ...
  },
  {
    ...
    image: "https://romuald.binarybloom.tech/assets/img/folio2.png",
    content:
      "C'est une révolution dans la gestion de la satisfaction et des retours d'avis clients, grâce au scan d'un code QR",
    stack: [
      {
        id: "icon-1",
        icon: SiDotnet,
  ...
  },
  {
    ...
    image: "https://romuald.binarybloom.tech/assets/img/folio3.png",
    content:
      "Partagez des documents entre collaborateurs, classez, archivez et recherchez vos documents.",
    stack: [
      {
        id: "icon-1",
        icon: SiRubyonrails,
  ...
  },
  {
    ...
    github: "",
    link: "",
    image: "https://romuald.binarybloom.tech/assets/img/folio5.png",
    content:
      "Application web complete de gestion d'un cabinet dentaire",
    stack: [
      {
        id: "icon-1",
        icon: SiRubyonrails,
  ...
  },
  {
    ...
    image: "https://romuald.binarybloom.tech/assets/img/folio8.png",
    content:
      "site web de presentation d'une agence informatique",
    stack: [
      {
        id: "icon-1",
        icon: SiDjango,
...
export const socialMedia = [
  {
    id: "social-media-1",
    icon: AiFillLinkedin,
    link: "https://www.linkedin.com/in/dev-romuald-07858624a/",
  },
  {
    id: "social-media-2",
    icon: AiFillGithub,
    link: "https://github.com/RomualdAKM",
  },
  {
    id: "social-media-3",
    icon: AiFillMail,
    link: "mailto:romuald91303142@gmail.com",
  },
  {
    id: "social-media-4",
...
export const aboutMe = {
    name: "Romuald AKANMOU",
    // tagLine: "Neant",
    intro: "Développeur web et mobile, qui est soit occupé à perfectionner son art, soit en train de réfléchir à la prochaine grande idée."
}
